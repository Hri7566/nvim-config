...
-- custom keybinds
vim.keymap.set('n', '<leader>b', ':ls<cr>:b<space>', { desc = 'Open [B]uffers' })
    ...
    { -- Fuzzy Finder (files, lsp, etc)
      ...
      config = function()
        ...
        require('telescope').setup {
          ...
          defaults = {
            file_ignore_patterns = { 'node_modules', '.git', '.cache', '.env', 'build', 'dist', 'bun.lockb', 'pnpm-lock.yaml', 'yarn.lock', 'package-lock.json' },
          },
        }
          ...
          callback = function(event)
            ...
            map('<leader>lr', function()
              ...
              vim.schedule(function()
                vim.api.nvim_echo({ { 'LSP restarted', 'MoreMsg' } }, false, {})
              end)
            end, '[L]SP [R]estart')
